...
# kubectl create -f $HOME/workspace/Sock-Shop-deployment-pipeline/sock-shop/namespace-sockshop.yaml
# sleep 3
...
# kubectl create -f $HOME/workspace/Sock-Shop-deployment-pipeline/sock-shop/sockshop-tls.yaml
# sleep 3
# kubectl create -f $HOME/workspace/Sock-Shop-deployment-pipeline/ingress-controllers/nginx-ingress-controller-eks-nlb.yaml
# sleep 120
# kubectl create -f $HOME/workspace/Sock-Shop-deployment-pipeline/ingress-controllers/nginx-ingress-class.yaml
...
# sed -i 's/8Gi/1Gi/g' $HOME/workspace/Sock-Shop-deployment-pipeline/sock-shop/complete-demo-with-persistence-aws.yaml
# kubectl create -f $HOME/workspace/Sock-Shop-deployment-pipeline/sock-shop/complete-demo-with-persistence-aws.yaml
# sleep 60
# kubectl create -f $HOME/workspace/Sock-Shop-deployment-pipeline/sock-shop/ingress-sockshop.yaml
